...
#pragma warning restore 618
    {
        ...
        /// <summary>
        /// The Monster model that will represent the anchor in the scene.
        /// </summary>
...
#pragma warning restore 618
        public void CmdSpawnStar(Vector3 position, Quaternion rotation)
        {
            ...
            var star = Instantiate(StarPrefab, position, rotation);
            Destroy(star, 30);
            //var projectileInstance = Instantiate(projectile, position, rotation);
            //projectileInstance.GetComponent<ProjectileMoveScript>().speed = 0.01f;
            ...
            //projectileInstance.transform.rotation = Quaternion.LookRotation(projectileInstance.transform.position - Camera.current.transform.position);
            //StartCoroutine(Waiter(projectileInstance)); ajouter la colison box 
...
#pragma warning restore 618
            ...
            var monster = Instantiate(MonsterPrefab, position+new Vector3(.1f, 0, 0), rotation);
#pragma warning disable 618
