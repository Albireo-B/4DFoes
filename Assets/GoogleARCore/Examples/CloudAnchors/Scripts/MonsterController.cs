...
namespace GoogleARCore.Examples.CloudAnchors
{
    ...
    public class MonsterController : MonoBehaviour
    {
        ...
        /// </summary>
        private GameObject m_MonsterMesh;
        ...
        public void Awake()
        {
            ...
            m_MonsterMesh = transform.Find("magmadar").gameObject;
            m_MonsterMesh.SetActive(false);
        }
